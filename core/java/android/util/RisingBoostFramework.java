...
public class RisingBoostFramework {
    ...
    **/
    ...
    private void initHintInfos() {
        ...
        workloadHints.put(WorkloadType.LOADING, new HintInfo(HINT_INTERACTION, BOOST, 0));
        workloadHints.put(WorkloadType.VENDOR_HINT_PACKAGE_INSTALL_BOOST, new HintInfo(HINT_INTERACTION, BOOST, 0));
        workloadHints.put(WorkloadType.LAUNCH, new HintInfo(HINT_LAUNCH, MODE, 0));
        ...
        workloadHints.put(WorkloadType.SUSTAINED_PERFORMANCE, new HintInfo(HINT_SUSTAINED, MODE, 0));
        workloadHints.put(WorkloadType.FIXED_PERFORMANCE, new HintInfo(HINT_FIXED_PERF, MODE, 0));
    }
